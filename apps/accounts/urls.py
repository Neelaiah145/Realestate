...
from .views import toggle_agent_status,phone_login_view,create_form,create_ass_form
...
urlpatterns = [
    ...
    path('phone_number_login/',phone_login_view,name="phone_login"),
    ...
    path('create_ass_form/',create_ass_form,name="create_ass_form"),
